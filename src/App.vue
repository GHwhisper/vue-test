<template>
  <div id="app">
    ...
    <!--  &lt;!&ndash;<my-input2>&ndash;&gt;-->
    <!--  &lt;!&ndash;  <template slot="prepend">prepend</template>&ndash;&gt;-->
    <!--  &lt;!&ndash;  <template slot="append">append</template>&ndash;&gt;-->
    <!--  &lt;!&ndash;</my-input2>&ndash;&gt;-->
    <!--</section>-->
